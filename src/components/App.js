...
import PlaygroundPage from "./sections/PlaygroundSection";
...
const App = () => {
  ...
  if (showPlayground) {
    return <PlaygroundPage onHidePlayground={() => setShowPlayground(false)} />;
  }
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className={cx(
            ...
            theme === "dark"
              ? "bg-gradient-to-bl from-orange-500 to-yellow-400"
              : "bg-gradient-to-bl from-orange-400 to-yellow-300"
          )}
          style={{
        ...
        >
          <defs>
            ...
            >
              <stop
                offset="0%"
                stopColor={theme === "dark" ? "#ef4444" : "#dc2626"}
              />
              <stop
                offset="100%"
                stopColor={theme === "dark" ? "#f97316" : "#ea580c"}
              />
            </linearGradient>
          </defs>
          <path
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="order-1 lg:order-2 relative flex justify-center items-center h-full">
              <FadeIn delay={300} direction="right">
                <div
                  className="relative w-80 h-80 sm:w-96 sm:h-96 group cursor-pointer"
                  style={{
                ...
                >
                  ...
                  <FloatingElement
                    delay={0.5}
                    className="absolute top-1/4 -left-12 group/icon"
                  >
                    <Droplets
                      size={28}
                      className={cx(
                        ...
                        theme === "dark"
                          ? "text-red-600 hover:text-blue-400"
                          : "text-red-400 hover:text-blue-500"
                      )}
                  ...
                  <FloatingElement
                    delay={2}
                    className="absolute bottom-1/4 -right-12 group/icon"
                  >
                    <Wind
                      size={24}
                      className={cx(
                        ...
                        theme === "dark"
                          ? "text-orange-600 hover:text-cyan-400"
                          : "text-orange-400 hover:text-cyan-500"
                      )}
                  ...
                  <FloatingElement
                    delay={3}
                    className="absolute top-1/2 -right-20 group/icon"
                  >
                    <Coffee
                      size={20}
                      className={cx(
                  ...
                  <FloatingElement
                    delay={4}
                    className="absolute top-1/2 -left-20 group/icon"
                  >
                    <Sparkles
                      size={22}
                      className={cx(
          ...
          <div className="max-w-6xl mx-auto px-6 sm:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2">
                <FadeIn delay={100}>
                  ...
                  >
                    Hello! I&apos;m Kaitlin, a software engineer with a passion
                    for creating engaging digital experiences that blend
                    functionality with aesthetics. My journey in tech began with
                    a fascination for how beautiful design and clean code can
                ...
                <FadeIn delay={200}>
                  ...
                  >
                    ...
                    challenges with both analytical rigor and creative thinking.
                  </p>
                </FadeIn>
                ...
                <FadeIn delay={300}>
                  ...
                  >
                    ...
                    into the latest design trends. I believe that great software
                  ...
                  >
                    ...
                    <ul className="space-y-4">
                      ...
                      >
                        ...
                        <span>
                          Creating intuitive, accessible experiences for all
                          users
                        </span>
                      </li>
                      <li
            ...
            <FadeIn delay={400}>
              ...
              <div
                ...
                style={{ maxHeight: showAllSkills ? "1000px" : "92px" }}
              >
