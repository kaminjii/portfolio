              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2">
                  <FadeIn delay={100}>
                    ...
                    >
                      Hello! I&apos;m Kaitlin, a software engineer with a
                      passion for creating engaging digital experiences that
                      blend functionality with aesthetics. My journey in tech
                      began with a fascination for how beautiful design and
                      clean code can come together to solve real-world problems.
                    </p>
                  </FadeIn>
