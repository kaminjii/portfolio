...
const experienceData = [
  ...
  },
  {
    ...
    achievements: [
      ...
      {
        icon: Target,
        text: "Optimized machine learning algorithms by refining hyperparameters and data cleaning, improving speed by 7%",
      },
      {
        icon: Trophy,
        text: "Reduced user fatigue with environment modifications, extending VR training sessions by up to 45 minutes",
      },
    ],
  },
];
    ...
    >
      <div
        className={cx(
          ...
          theme === "dark"
            ? "bg-stone-700/50 group-hover:bg-red-500/20"
            : "bg-stone-100 group-hover:bg-red-50"
        )}
      >
      ...
      >
        <div className="max-w-6xl mx-auto px-6 sm:px-12">
          <div className="mb-16">
            ...
            >
              From research labs to enterprise solutions, here&apos;s how
              I&apos;ve grown as a software engineer and contributed to
              meaningful projects.
            </p>
          </div>
            ...
            {experienceData.map((exp, index) => (
              <div
                ...
                className={cx(
                  ...
                  theme === "dark"
                    ? "bg-stone-900/40 border-stone-700/60"
