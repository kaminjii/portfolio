            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center group">
                <div className={cx(
                  ...
                  theme === 'dark' 
                    ? "bg-gray-800 group-hover:bg-teal-900/40 group-hover:text-teal-400" 
                    : "bg-gray-100 group-hover:bg-teal-100 group-hover:text-teal-600"
                )}>
                  <Mail size={24} />
                </div>
                <a 
          ...
          <form onSubmit={handleSubmit} className={cx(
            ...
            <div className="mb-6 relative">
              ...
              <input
                ...
                onBlur={handleBlur}
                className={cx(
                  "w-full border rounded p-3 pt-5 focus:outline-none transition-colors duration-300",
                  theme === 'dark' 
                    ? "bg-gray-900/60 text-white" 
                    : "bg-gray-50 text-gray-900",
                  focused === 'name' ? "border-teal-400" : theme === 'dark' ? "border-gray-700" : "border-gray-300"
                )}
                required
              />
            </div>
              ...
              <input
                ...
                className={cx(
                  ...
                  theme === 'dark' 
                    ? "bg-gray-900/60 text-white" 
                    : "bg-gray-50 text-gray-900",
                  focused === 'email' ? "border-teal-400" : theme === 'dark' ? "border-gray-700" : "border-gray-300"
                )}
                required
              />
            </div>
              ...
              <textarea
                ...
                className={cx(
                  ...
                  theme === 'dark' 
                    ? "bg-gray-900/60 text-white" 
                    : "bg-gray-50 text-gray-900",
                  focused === 'message' ? "border-teal-400" : theme === 'dark' ? "border-gray-700" : "border-gray-300"
                )}
                required
              ></textarea>
            </div>
            ...
            <div className="text-right">
              <button
                ...
                className={cx(
                  "group relative overflow-hidden border border-teal-400 text-teal-400 px-6 py-3 rounded hover:bg-teal-900/20 transition-all duration-300",
              ...
              >
                ...
                <span className={cx(
                  "absolute left-0 right-0 transition-transform duration-300",
