...
const projectsData = [
  {
    ...
    description:
      "iOS app built with SwiftUI, featuring real-time data sync and social authentication.",
    ...
    category: "mobile",
    links: {
      github: "https://github.com/kaminjii/glow2",
    },
  },
  {
    id: "dropawf",
    ...
    description:
      "Full-stack courier service web application with multi-role authentication.",
  ...
  },
  {
    ...
    description:
      "Pixel art puzzle game with custom level creation and physics mechanics.",
  ...
  },
  {
    ...
    title: "Wordle",
    description:
      "Word puzzle game with modular components and Jenkins CI/CD pipeline.",
  ...
  },
  {
    ...
    description:
      "Data analysis on 68K+ records to identify correlations between asthma hotspots and UPRR lines.",
  ...
  },
  {
    ...
    title: "Fighting Game",
    description:
      "Unity fighting game with custom 2D animations and physics engine.",
  ...
  },
  {
    ...
    title: "Pager+",
    description:
      "Network pager system with Twilio SMS integration and AI risk assessment.",
  ...
  },
  {
    ...
    description:
      "Custom programming language with parser, interpreter, and REPL interface.",
  ...
  },
  {
    ...
    description:
      "Multithreaded C++ program for real-time entropy computation from data streams.",
    tech: ["C++"],
    links: {},
    image: null,
    featured: false,
        ...
        >
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <Image
              src={
                project.image ||
                `https://placehold.co/600x400/${project.color?.split("-")[1]?.split("/")[0] || "CCCCCC"}/FFFFFF?text=${encodeURIComponent(project.title)}`
              }
              alt={project.title}
              layout="fill"
              objectFit="cover"
    ...
    <FadeIn delay={delay} className="w-full">
      ...
      >
        <div className="flex justify-between items-start mb-3">
          <h3
            className={cx("text-lg font-medium font-serif", accentColorTitle)}
          >
            {project.title}
          </h3>
...
const ProjectsSection = ({ sectionRef }) => {
  ...
  const categoryButtonActiveBg =
    theme === "dark" ? "bg-red-600 text-white" : "bg-red-700 text-white";
  const categoryButtonIdleBg =
    theme === "dark"
      ? "bg-stone-800 text-stone-300 hover:bg-stone-700"
      : "bg-stone-100 text-stone-700 hover:bg-stone-200";
  const viewAllButtonBg =
    theme === "dark"
      ? "bg-stone-800 text-stone-200 hover:bg-stone-700 hover:text-red-400"
      : "bg-stone-100 text-stone-800 hover:bg-stone-200 hover:text-red-600";
